...
{
    /// <summary>
    /// 닷넷 프레임워크 기반의 응용 프로그램에서 데이터베이스에 응용프로그램 코드의 실행을 추적 할 수 있도록 로그 기능을 구현합니다.
    /// </summary>
    public class Database : ILogAdapter
    {
        /// <summary>
        /// 데이터베이스에서 로그를 가져오거나, 설정할 때 발생하는 마지막 예외 메시지 입니다.
        /// </summary>
        private string exceptionMessage = "";

        /// <summary>
        /// 데이터베이스에서 로그를 가져오거나, 설정할 때 발생하는 마지막 예외 메시지를 가져오거나, 설정합니다.
        /// </summary>
        ...
        /// <summary>
        /// 데이터베이스에서 조건식을 분석하여 로그 항목값을 가져옵니다.
        /// </summary>
        /// <param name="condition">런타임에 확인될 작업이 포함된 개체입니다.</param>
        ...
        /// <summary>
        /// 데이터베이스에서 로그 항목값에 대한 레벨 수준, 일자 기간항목값을 기준으로 런타임에 확인될 작업이 포함된 개체를 가져옵니다.
        /// </summary>
