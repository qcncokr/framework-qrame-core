...
namespace Qrame.CoreFX.Exceptions
{
    ...
    /// </summary>
    /// <code>
    /// ExceptionFactory.Register("Exception", new DefaultException());
    /// ....
    /// ExceptionFactory.Handle("Error Message", new Exception());
    /// </code>
    public class DefaultException : ExceptionBase
    {
        /// <summary>
        /// 기본 생성자입니다.
        /// </summary>
        ...
        public DefaultException(string handlerName)
        {
        ...
        protected override void InternalHandle(string message, Exception e, dynamic arguments)
        {
            ...
            entry.Level = EntryLevel.Miscellaneous;
