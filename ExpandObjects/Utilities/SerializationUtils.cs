...
namespace Qrame.CoreFX.ExpendObjects
{
    ...
    internal static class SerializationUtils
    {
        ...
        public static bool SerializeObject(object instance, string fileName, bool binarySerialization)
        {
            ...
            if (!binarySerialization)
            {
                ...
                {
                    Debug.Write("SerializeObject failed with : " + exception.Message, "West Wind");
                    retVal = false;
                }
                finally
                {
        ...
        public static bool SerializeObject(object instance, XmlTextWriter writer, bool throwExceptions)
        {
            ...
            {
                Debug.Write("SerializeObject failed with : " + exception.GetBaseException().Message + "\r\n" + (exception.InnerException != null ? exception.InnerException.Message : ""), "West Wind");
        ...
        public static bool SerializeObject(object instance, out byte[] resultBuffer, bool throwExceptions = false)
        {
            ...
            {
                Debug.Write("SerializeObject failed with : " + exception.GetBaseException().Message, "West Wind");
                retVal = false;
