...
namespace Qrame.CoreFX.ExtensionMethod
{
    ...
    public static class StreamExtensions
    {
        ...
        /// </summary>
        public static void CopyStream(this Stream @this, Stream dest, int bufferSize)
        {
        ...
        public static void CopyStream(this Stream @this, Stream dest, int bufferSize, bool append)
        {
            if (append)
                dest.Seek(0, SeekOrigin.End);

            CopyStream(@this, dest, bufferSize);
            return;
        }
        ...
        /// </summary>
        /// <param name="stream">The @this stream.</param>
        /// <param name="targetStream">The target stream.</param>
        /// <returns>The @this stream.</returns>
