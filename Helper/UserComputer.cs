...
namespace Qrame.CoreFX.Helper
{
  public static class UserComputer
  {
    ...
    public static bool Is64BitOS { get { return Environment.Is64BitOperatingSystem; } }
    ...
    public static string IpAddress { get { return GetLocalIPAddress(); } }
    public static string MacAddress { get { return GetLocalMacAddress(); } }
